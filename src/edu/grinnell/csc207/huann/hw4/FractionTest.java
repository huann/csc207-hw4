...
public class FractionTest {
	...
	assertEquals("fraction to string", "1/2", new Fraction(1,2).toString());
	assertEquals("fraction to string", "1/2", new Fraction(BigInteger.valueOf(1), BigInteger.valueOf(2)).toString());
